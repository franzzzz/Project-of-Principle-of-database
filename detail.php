                                            ...
                                            <div class="col-lg-12">
                                                <div class="detail-tabs">
                                                    ...
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        ...
                                                        <li role="presentation"><a href="#post" aria-controls="post" role="tab" data-toggle="tab">Posts</a></li>
...
<!--                                                                 <div class="post-block summary-sec rich_editor_text">
                                                                   ...
                                                                   <div class="row">
                                                                    <article class="col-lg-12">
                                                                      <div class="main-thumb">
                                                                       <figure>
                                                                         <a href="#"><img src="assets/extra-images/blog-lrg1.jpg" alt="blog"></a>
                                                                     </figure>
                                                                 </div>
                                                                 <div class="bloginfo-sec">
                                                                   <div class="date-time">
                                                                    <time datetime="2014-12-03"><small>28</small>DEC</time>                 
                                                                </div>
                                                                <div class="blog-text">
                                                              ...
                                                              <h2><a href="#">Disagreed rode some hey wherever more avoidable.</a></h2>
                                                              <p>Disagreed rode some hey wherever more avoidable and regardless a barring much but naughtily when limpet far sporadically a since this essential jay dear where avowed much far far laudable suavely that and considering. Surely barring much but naughtily when limpet logically elephant far foolishly clapped.</p>
                                                              <div class="post-thumb">
                                                               <figure> 
                                                                 <a href="#"><img src="assets/extra-images/img-adminpost2.png" alt="#"> </a>
                                                             </figure>
                                                             <ul class="thumb-options">
                                                                 <li>Posted by <br>
                                                                  <a href="#">Sunshine Agency</a>
                                                              </li>
                                                          </ul>
                                                          <a href="#" class="Continue-Readingbtn cscolor">Continue Reading</a>
                                                      </div>
                                                  </div>
                                              </div>
                                          </article>
                                          ...
                                          <article class="col-lg-12">
                                              <div class="main-thumb">
                                               <div class="video-player">
                                                <iframe src="http://player.vimeo.com/video/62085613?badge=0&amp;color=69b8d6" height="492"></iframe>
                                            </div>
                                        </div>
                                        <div class="bloginfo-sec">
                                         <div class="date-time">
    ...
    <div class="page-content col-lg-9">
        <div class="cs-blog blog-medium">
            <div class="row">
                <article class="col-lg-12">
                  <div class="main-thumb">
                    <figure><a href="#"><img src="assets/extra-images/blog-med2.png" alt="blog"></a>
                        <figcaption>
                      ...
                      <a href="#"><i class="icon-uniEAB5"></i></a>
                  </figcaption>
              </figure>
          </div>
          <div class="bloginfo-sec">
                    ...
                    <ul>
                        <li>
                            ...
                            <div class="dropdown-area">
                                ...
                                <ul class="dropdown">
                                    <li><a href="causes.html"><i class="icon-flag5"></i>My Causes</a></li>
                                    <li><a href="saved.php"><i class="icon-file-text-o"></i>Saved Causes</a></li>
                                    <li><a href="my-donation.php"><i class="icon-file-text-o"></i>My Donations</a></li>
                                    <li><a href="donation.html"><i class="icon-ticket6"></i>Donations</a></li>
                                    <li><a href="profilesetting.html"><i class="icon-pie2"></i>Profile Settings</a></li>
                                    <li><a href="create-new-cause.html"><i class="icon-plus6"></i>Create New</a></li>
