                                ...
                                <div class="col-lg-12">
                                  <div class="profile-block">
                                    <ul class="scroll-nav">
                                      ...
                                      <li class="active"><a href="my-donation.php"><i class="icon-money"></i>My Donation</a></li>
															...
															<div class="cs-profile-holder">
																<div class="cs-table-holder">
																	<table>
																		...
																		<tbody>
                                      <?php 
                                      $query_show_all_donation = "SELECT * From pledge WHERE username = '{$loginUsername}'";
                                                      $result_show_all_donation = @ mysqli_query($connection, $query_show_all_donation); 
                                                      $count_show_all_donation = 0;
                                                      while($line_show_all_donation = mysqli_fetch_array($result_show_all_donation)){
                                                        $count_show_all_donation+=1;
                                                        echo "
                                                        <tr>
                                                          <td>".$count_show_all_donation."</td>
                                                          
                                                          <td>".$line_show_all_donation[2]."</td>
                                                          ";
                                                          if($line_show_all_donation[5] == 0) echo "<td>pending</td>";
                                                          else echo"<td>excuted</td>";
                                                          echo "
                                                          <td>$".$line_show_all_donation[4]."</td>
                                                        </tr>
                                                        ";
                                                      }
                                      ?>
