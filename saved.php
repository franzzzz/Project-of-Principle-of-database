                                         ...
                                         while($line_show_save_pro = mysqli_fetch_array($result_show_save_pro)){
                                          ...
                                          <article>
                                            <div class=\"post-main\">
                                              ...
                                              <figure>
                                                <a href=\"#\" onclick=\"window.location.href='detail.php?pid_detail=".$line_show_save_pro[0]."'\"><img alt=\"\" src=\"assets/extra-images/img.jpg\"></a>
                                              </figure>
                                              <div class=\"detail-area\">
                                                ...
                                                <div class=\"text\">
                                                  <h3><a href=\"#\" onclick=\"window.location.href='detail.php?pid_detail=".$line_show_save_pro[0]."'\">".$line_show_save_pro[2]."</a></h3>
